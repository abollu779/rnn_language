For the code Algorithm Speech-to-Text:

The only parameters to change are:

- The path of the credential_file, which has to be linked to a Google Cloud account
- The path for the audio file studied
