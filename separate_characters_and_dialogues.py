...
def formatDialogueData(movie_name):
    with open('screenplays/formattedtxts/{}.txt'.format(movie_name), 'r') as f:
    ...
    with open('screenplays/characters_and_dialogues/{}_characters.txt'.format(movie_name), 'w+') as g:
        for character in characters:
            g.write("{}\r\n".format(character))
    with open('screenplays/characters_and_dialogues/{}_dialogues.txt'.format(movie_name), 'w+') as h:
